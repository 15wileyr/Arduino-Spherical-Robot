...
float Xaccel =0.1; // [meters/sec^2]  Max AcceleratSHEEON !!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!!
float Xstepaccel = Xaccel*(1/(pi*2*radius*0.005));// [steps/sec^2]
float ThrottleRead = 0.0;
float Xlaststepspeed = 0.0; //[step/sec]
float Xlastspeed = 0.000001;
