...
int DrivingAccel = 150;       //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Acceleration Value when in motion  (smaller is higher acceleration)
int TurninplaceAccel = 20;    //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Acceleration Value when turning in place (smaller is higher acceleration)
int Slowspeed = 5000;         //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Minimum Driving speed smaller is faster
int Topspeed = 700;           //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Highest Driving Speed smaller is faster
int Reversemaxspeed = 1000;   //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Highest Driving speed in reverse smaller is faster

int Maxturninplace = 9800;    //!!!~~~~~~~~~~~~~~~~~~~SET ME PLZ~~~~~~~~~~~~~~~~~~~!!! Maximum turning pulse length smaller means turn faster
